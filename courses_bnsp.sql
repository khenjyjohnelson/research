...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 06, 2024 at 07:24 AM
...
(7, 'pengaturan', 'pengaturan', 'pengaturan.png', '<i class=\"fas fa-cog\"></i>', 'a', 6),
(9, 'user', 'user', 'user.png', '<i class=\"fas fa-address-card\"></i>', 'c', 6),
(11, 'operations', 'operations', 'operations.png', '<i class=\"fas fa-concierge-bell\"></i>', 'f', 6),
(12, 'decoration', 'decoration', 'decoration.png', '<i class=\"fas fa-snowman\"></i>', 'b', 6),
(13, 'home', 'home', 'home.png', '<i class=\"fas fa-home\"></i>', '0', 6),
(14, 'login', 'login', 'login.png', '<i class=\"fas fa-sign-in-alt\"></i>', '0', 6),
(15, 'signup', 'signup', 'signup.png', '<i class=\"fas fa-user-plus\"></i>', '0', 6),
(16, 'dashboard', 'dashboard', 'dashboard.png', '<i class=\"fas fa-desktop\"></i>', '0', 6),
(17, 'no-level', 'no-level', 'no-level.png', '<i class=\"fas fa-user-slash\"></i>', '0', 6),
(19, 'events', 'events', 'events.png', '<i class=\"fas fa-calendar-alt\"></i>', 'b', 6),
(20, 'website_licenses', 'website_licenses', 'website_licenses.png', '<i class=\"fas fa-check-square\"></i>', 'b', 6),
(21, 'website_sosmed', 'website_sosmed', 'website_sosmed.png', '<i class=\"fab fa-instagram-square\"></i>', 'b', 6),
(22, 'template', 'template', 'template.png', '<i class=\"fas fa-dice-d6\"></i>', '0', 6),
(23, '404', '404', '404.png', '<i class=\"far fa-times-circle\"></i>', '0', 6),
(24, 'website_themes', 'website_themes', 'website_themes.png', '<i class=\"fas fa-umbrella-beach\"></i>', 'b', 6),
(25, 'migrations', 'migrations', 'migrations.png', '<i class=\"fas fa-database\"></i>', 'b', 6),
(26, 'failed_jobs', 'failed_jobs', 'failed_jobs.png', '<i class=\"far fa-frown\"></i>', 'b', 6),
(27, 'website_notif_type', 'website_notif_type', 'website_notif_type.png', '<i class=\"fas fa-flag\"></i>', 'b', 6),
(28, 'website_notifications', 'website_notifications', 'website_notifications.png', '<i class=\"fas fa-bell\"></i>', 'b', 6),
(29, 'personal_access_tokens', 'personal_access_tokens', 'personal_access_tokens.png', '<i class=\"fas fa-key\"></i>', 'd', 6),
(30, 'failed_jobs', 'failed_jobs', 'failed_jobs.png', '<i class=\"fas fa-unlock-alt\"></i>', 'b', 6),
(31, 'login_histories', 'login_histories', 'login_histories.png', '<i class=\"fas fa-laptop-house\"></i>', 'd', 6),
(32, 'obat', 'obat', 'obat.jpg', '<i class=\"fas fa-pills\"></i>', 'a', 6);
...
CREATE TABLE `obat` (
  ...
  `golongan` enum('obat bebas','obat terbatas','obat keras','psikotropika') NOT NULL,
...
INSERT INTO `obat` (`kode`, `nama_obat`, `golongan`, `stok`, `harga`) VALUES
('MED00003', 'Amoxicillin', 'obat keras', 30, '2500.00'),
('MED00004', 'Diazepam', 'psikotropika', 20, '5000.00'),
('MED00005', 'Ibuprofen', 'obat terbatas', 40, '3000.00'),
('MED00006', 'Cetirizine', 'obat bebas', 60, '2000.00'),
('MED00007', 'Metformin', 'obat keras', 25, '3500.00'),
('MED00008', 'Alprazolam 2', 'obat keras', 20, '6500.00'),
('MED00009', 'Amoxicillin', 'obat terbatas', 50, '3000.00'),
('MED00010', 'Paracetamol', 'obat terbatas', 50, '3000.00');
...
(1, 'KIMIA FARMAKU', 'Jl Peternakan Dlm III 36, Dki Jakarta', 'kimia.farmaku@gmail.com', '0-21-541-3829', 1, 11, 6);
...
(225, 1, 'action_completed_successfully', 'Theme ID successfully updated! (ID = 1)', '2024-06-06 13:27:52', NULL),
(226, 1, 'action_completed_successfully', 'Obat successfully saved!', '2024-06-06 13:28:07', NULL),
(227, 1, 'action_completed_successfully', 'Obat successfully saved!', '2024-06-06 13:35:47', NULL),
(228, 1, 'action_completed_successfully', 'Obat successfully saved!', '2024-06-06 13:44:49', NULL),
(229, 1, 'action_completed_successfully', 'Social Media Account successfully deleted! (ID = 3)', '2024-06-06 13:45:22', NULL),
(230, 1, 'action_completed_successfully', 'Obat successfully deleted! (ID = MED00001)', '2024-06-06 13:46:18', NULL),
(231, 1, 'action_completed_successfully', 'Obat successfully deleted! (ID = MED00002)', '2024-06-06 13:46:23', NULL);
...
--
ALTER TABLE `decoration`
  MODIFY `id_decor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `website_notifications`
  MODIFY `id_notif` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=232;
